...
function makeQuote() {
  ...
  const worksheet = makeWorksheet(workbook)
  ...
  designIntroduceSection(worksheet)
  settingRowAndHeightFormat(worksheet)
...
function makeWorksheet(workbook) {
...
function designIntroduceSection(worksheet) {
  //row1 style
...
function settingRowAndHeightFormat(worksheet) {
  //set column width
